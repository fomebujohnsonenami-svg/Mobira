  ...
  return (
    <div className="min-h-screen bg-navy-950 text-slate-100 flex flex-col items-center justify-center p-4 sm:p-6 selection:bg-yellow-500 selection:text-navy-950">
      <div className="max-w-md w-full space-y-6">
        ...
        <Card className="p-5 bg-navy-900 border-2 border-yellow-500/50 shadow-modal relative overflow-hidden">
          <div className="flex items-center justify-between gap-2 pb-3 border-b border-navy-800">
            <div className="flex items-center gap-2">
              ...
              <span className="font-black text-xs uppercase tracking-wider text-yellow-400">
                Competition Judge Fast-Track
              </span>
            </div>
            <span className="px-2 py-0.5 rounded text-[10px] font-extrabold bg-blue-600 text-white flex items-center gap-1">
              <CheckCircle2 className="w-3 h-3" /> ABC Technologies Ltd ✓
            </span>
          </div>

          <p className="text-xs text-slate-300 mt-2.5 leading-relaxed">
            Instantly launches the seeded demo dashboard with pre-configured telemetry, verified business identity, and simulated telecom rails.
          </p>
          ...
          <div className="mt-4">
            <Button
              ...
              className="w-full gap-2 font-black py-3 text-sm shadow-elevated"
            >
        ...
        <Card className="p-6 bg-white dark:bg-navy-900 border border-slate-200 dark:border-navy-800 text-slate-900 dark:text-slate-100 shadow-subtle space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input
              ...
              placeholder="jeanne.ngono@abctechnologies.cm"
              required
            />
